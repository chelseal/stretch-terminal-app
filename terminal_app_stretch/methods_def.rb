...
def wrist_forearm_stretch
    "Straighten your arm, holding your fingers, gently bend wrist up until you feel a stretch in the forearm. Hold for 15 seconds then release. Holding your fingers, gently bend wrist down until you feel a stretch in the forearm, hold for 15 seconds then release. Repeat with your other arm."
end

def upper_trap_stretch
    "Gently pull your head toward each shoulder until a light stretch is felt. Hold the pose for 10 to 15 seconds. Alternate once on each side."
end
